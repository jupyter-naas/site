...
![Naas Search](../get-started/img/NaasSearch.gif)
...
![](__assets__/templates/Templates_Header.PNG)
...
![](__assets__/templates/Templates_Outline.PNG)
...
![](__assets__/templates/Templates_GiveFeedback.PNG)

## Reporting A Bug

Since all our templates are open-source, errors may occasionally occur. We apologize for any inconvenience that may cause and request your support in reporting these issues to help us rectify them.
To report a bug, click on the link at the top of the notebook. You will be redirected to GitHub to create an issue. Please attach screenshots to help us understand the bug, and provide any other information that could assist us in reproducing the issue.
We will strive to respond as quickly as possible to resolve the issue.

![](__assets__/templates/Templates_BugReport.PNG)

## How to contribute?

### Pre-requisites
- Register for the [Open Source Contributor Program](https://bit.ly/48EdEjZ) so we can add you to the team of contributors in the Naas GitHub organization. To start working on our repository, you must be a part of our [open-source contributors team](https://github.com/orgs/jupyter-naas/teams/opensource-contributors). Please check your email and validate the invitation before you begin working on a new issue.
